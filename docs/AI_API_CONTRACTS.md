...
## 4A. Authenticated persistent chat

These endpoints are for the real chatbot UI with saved history. They require auth and store every user/assistant turn in the database.

### Availability and fallback behavior

- When the backend chat endpoint is healthy, chat history is database-backed and loaded from the server.
- During backend `503` fallback, replies may be generated by a frontend OpenAI route and cached locally so users are not blocked.
- If you require strict always-database persistence even during provider outages, add a backend endpoint that accepts and stores externally generated assistant replies.
- Without that backend endpoint, frontend-generated fallback replies cannot be guaranteed as server-side history.
...
```json
{
  "message": "Help me find a marketing expert",
  "context": "dashboard",
...
```json
{
  ...
  "data": {
    "conversation": {
      "id": "0c4d7a10-3f43-4d7d-8a3f-5fcb77f31d8d",
      "title": "Help me find a marketing expert",
      "createdAt": "2026-05-02T10:00:00.000Z",
      "updatedAt": "2026-05-02T10:00:02.000Z"
    },
    "userMessage": {
      "id": "d92c7f54-06f8-49b5-b0d4-5a44f6c6dbb1",
      "role": "user",
      "content": "Help me find a marketing expert",
      "feedback": null,
      "model": null,
      "provider": null,
      "tokensUsed": 0,
    ...
    "assistantMessage": {
      "id": "eb622561-2d37-45b8-a26e-bbf0eaf3b5b3",
      "role": "assistant",
      "content": "Here are a few ways to narrow that down...",
      "feedback": null,
      "model": "gpt-4o-mini",
      "provider": "openai",
      "tokensUsed": 185,
...
Frontend notes:
- To start a new chat, omit `conversationId`.
- To continue an existing chat, pass the current `conversationId`.
- Copy is client-side only: copy `assistantMessage.content`.
- Like/dislike uses the `assistantMessage.id` returned here.
  ...
  "data": [
    {
      "id": "0c4d7a10-3f43-4d7d-8a3f-5fcb77f31d8d",
      "title": "Help me find a marketing expert",
      "preview": "Here are a few ways to narrow that down...",
      "lastMessageRole": "assistant",
      "lastMessageAt": "2026-05-02T10:00:02.000Z",
      "messageCount": 2,
      "createdAt": "2026-05-02T10:00:00.000Z",
      "updatedAt": "2026-05-02T10:00:02.000Z"
    }
...
### PATCH /api/v1/ai/chat/conversations/:conversationId/messages/:messageId/feedback
...
Use `"DISLIKE"` to dislike, or `null` to clear the rating.
