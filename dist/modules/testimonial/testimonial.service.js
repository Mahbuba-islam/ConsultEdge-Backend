...
// CREATE TESTIMONIAL
// ------------------------------
const createTestimonial = async (userId, payload) => {
    ...
    if (!consultation.expertId) {
        throw new AppError(status.BAD_REQUEST, "Consultation has no expert assigned");
    }
...
// ------------------------------
const getAllTestimonials = async (query, includeAll = false) => {
...
const getAllTestimonialsForAdmin = async (query, includeAll = true) => {
    return getAllTestimonials(query, includeAll);
};
// ------------------------------
// GET TESTIMONIALS BY EXPERT
// ------------------------------
const getTestimonialsByExpert = async (expertId) => {
...
// ------------------------------
const replyToTestimonial = async (id, expertUserId, payload) => {
    const expert = await prisma.expert.findUnique({
...
// ------------------------------
const updateTestimonial = async (id, userId, payload) => {
    // ✅ get client
    const client = await prisma.client.findUnique({
        where: { userId },
    });
