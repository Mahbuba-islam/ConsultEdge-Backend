...
const getBetterAuthSessionToken = (req) => req.cookies["better-auth.session_token"] ??
...
const loginUser = catchAsync(async (req, res) => {
    ...
    const { accessToken, refreshToken, token, // BetterAuth session token
...
// });
const handlerOAuthError = catchAsync(async (req, res) => {
